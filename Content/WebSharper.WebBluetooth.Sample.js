...
(function(Global)
{
 ...
 WebSharper$WebBluetooth$Sample_Templates=Global.WebSharper$WebBluetooth$Sample_Templates=Global.WebSharper$WebBluetooth$Sample_Templates||{};
 ...
 SC$1=Global.StartupCode$WebSharper_WebBluetooth_Sample$Client=Global.StartupCode$WebSharper_WebBluetooth_Sample$Client||{};
 ...
 {
  var _,b,_this,t,p,i;
  _=(b=(_this=(t=new ProviderBuilder.New$1(),(t.h.push(Handler.EventQ2(t.k,"connectbluetooth",function()
  {
   return t.i;
  },function()
  {
   ...
   {
    return Concurrency.Bind(Promise.AsAsync(Client.connectBluetooth()),function()
    {
     return Concurrency.Return(null);
    });
   })),null);
  })),t)),(_this.h.push(new TextView.New("status",Client.statusMessage().get_View())),_this)),(p=Handler.CompleteHoles(b.k,b.h,[]),(i=new TemplateInstance.New(p[1],WebSharper$WebBluetooth$Sample_Templates.main(p[0])),b.i=i,i))).get_Doc();
 ...
 Client.connectBluetooth=function()
 {
  var _;
  function f()
  {
   ...
   {
    var r;
    return Client.bluetooth().requestDevice((r={},r.acceptAllDevices=true,r.optionalServices=["battery_service"],r)).then(function(a)
    {
     var deviceName;
     deviceName=a.name==null?"Unknown Device":a.name;
     Client.statusMessage().Set("Connected to: "+Global.String(deviceName));
     console.log("Device Info:",a);
     return a.gatt.connect().then(function(a$1)
     {
      console.log("Connected to GATT Server!");
      return a$1.getPrimaryService("battery_service").then(function(a$2)
      {
       return a$2.getCharacteristic("battery_level").then(function(a$3)
       {
        return Promise.OfAsync(Promise.AsAsync(a$3.readValue())).then(function(a$4)
        {
         var batteryLevel;
         batteryLevel=a$4.getUint8(0);
         Client.statusMessage().Set(Utils.toSafe(Client.statusMessage().Get())+" - Battery: "+Global.String(batteryLevel)+"%");
   ...
   function f$2(a)
   {
    console.error("Bluetooth Connection Failed:",a.message);
    Client.statusMessage().Set("Bluetooth connection failed!");
    return Promise$1.resolve(null);
   }
 ...
 Client.bluetooth=function()
 {
  SC$1.$cctor();
  return SC$1.bluetooth;
 };
 ...
 WebSharper$WebBluetooth$Sample_Templates.main=function(h)
 {
 ...
 SC$1.$cctor=function()
 {
  ...
  SC$1.statusMessage=Var$1.Create$1("Click the button to connect Bluetooth.");
  SC$1.bluetooth=self.navigator.bluetooth;
 };
